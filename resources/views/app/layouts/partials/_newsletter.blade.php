<div class="container px-8 mx-auto">
    <div class="max-w-6xl p-12 mx-auto my-8 border-2 rounded-lg md:my-16 newsletter-signup border-slate-300">
        <div class="flex grid items-center grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            <div class="flex flex-col items-start lg:items-end">
                <form class="flex flex-col flex-wrap justify-start w-full gap-3 sm:flex-row sm:w-auto" aria-labelledby="newsletter-headline" method="POST" action="{{ route('newsletter.store') }}">
                    ...
                    <input type="submit" class="px-4 py-2 rounded-md cursor-pointer bg-gradient-to-tr hover:from-yellow-500 transition-colors hover:to-yellow-500 from-[#efe73e] to-[#50b1bf] text-black" value="{{ __('app/newsletter.form.button') }}">
                </form>
                @error('email')

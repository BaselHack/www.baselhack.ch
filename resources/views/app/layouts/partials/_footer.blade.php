            ...
            @if(!empty($channels) and $channels->count())
                @foreach($channels as $channel)
                    <a href="{{ $channel->url }}" title="{{ $channel->name }}" target="_blank"
                       class="channel h-12 w-12 py-4 bg-gray-700 text-gray-400 rounded-full overflow-hidden hover:bg-white">
                        <span class="sr-only">
                          {{ $channel->name }}
                        </span>
                        ...
                        @switch($channel->name)
                                @case('Github')
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="h-6 w-6" fill="currentColor">
                                    ...
                                    @break
                                @case('Youtube')
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-6 w-6" fill="currentColor">
                                    <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <path
                                ...
                                @default
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="h-6 w-6" fill="currentColor">
                                    <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <path

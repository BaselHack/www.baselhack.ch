    ...
    <x-page :title="$title" :teaser="$teaser">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            @foreach($posts as $post)
                <article class="flex flex-col block gap-2 p-6 border border-teal-900 rounded-lg blog-post bg-neutral-900">
                    ...
                    <a class="flex items-center self-start gap-2 px-4 py-2 mt-4 mt-auto bg-gradient-to-tr hover:from-yellow-500 transition-colors hover:to-yellow-500 from-[#efe73e] to-[#50b1bf] text-black rounded-md" href="{{ route('posts.show',$post) }}">

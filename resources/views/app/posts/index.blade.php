        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            @foreach($posts as $post)
                <article class="flex flex-col gap-2 p-6 border border-teal-900 rounded-lg blog-post bg-neutral-900">
                    ...
                    <a class="flex items-center self-start gap-2 px-4 py-2 mt-4 mt-auto text-black bg-yellow-500 rounded-md focus:bg-yellow-500 focus:outline hover:bg-yellow-600 outline-offset-2 outline-2 outline-yellow-500" href="{{ route('posts.show',$post) }}">

...
<div class="container py-8 mt-24">
    <div class="cta-element my-8 text-black md:my-16 bg-[#efe73e] card-shine appearance-none relative overflow-hidden p-12 before:absolute before:content-[''] rounded-sm group outline-none">
        <div class="flex flex-col items-start w-full">
            ...
            <h4 class="relative mb-3 pointer-events-none">Get your ticket in exchange for a deposit of 20 CHF on eventfrog.ch</h4>
            <a class="relative flex gap-4 px-6 py-3 mt-4 text-yellow-400 bg-black rounded-lg focus:outline outline-offset-2 outline-2 outline-black w-fit" href="https://eventfrog.ch/de/p/wissenschaft-und-technik/baselhack-2023-7059415336391468199.html" target="_blank">
            ...
            <div class="relative block w-full pt-2 mt-4 border-t border-black md:flex md:mt-8 grid-col-1 md:grid-cols-2">
                <hr class="border-black">
                <div class="flex flex-col items-start justify-end w-full mt-4 md:mt-0 text-start">
                    <a href="https://www.letsboot.ch/basel-boot-2023" target="_blank">
                        Bonus: <span class="underline">Register for BaselBoot 2023 course</span><br> by letsboot.ch for 90.-- CHF
                    </a>
                </div>
                <div class="flex flex-col items-start justify-end mt-4 md:items-end md:mt-0">
                    <small class="inline-block mb-2">sponsored by:</small>
                    <a href="https://flow.swiss" target="_blank">
                        <svg width="158px" height="36px" viewBox="0 0 158 36" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">

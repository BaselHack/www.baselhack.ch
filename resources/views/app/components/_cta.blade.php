...
<div class="container py-8 mt-24">
    <div
        class="
            cta-element
            my-8
    ...
    >
        <div class="flex flex-col items-start w-full">
            <h1 class="relative text-2xl pointer-events-none md:text-4xl">
                <strong>Participate in BaselHack 2023 in October?</strong>
            </h1>
            <h4 class="relative mb-3 pointer-events-none">
                Get your ticket in exchange for a deposit of 20 CHF on
                eventfrog.ch
            </h4>
            <a
                class="
                    ...
                    rounded-lg
                    focus:outline
                    outline-offset-2 outline-2 outline-black
                    w-fit
                "
                href="https://eventfrog.ch/de/p/wissenschaft-und-technik/baselhack-2023-7059415336391468199.html"
                target="_blank"
            >
                ...
                >
                    <a
                        class="
                            ...
                            hover:underline
                        "
                        href="https://www.letsboot.ch/basel-boot-2023"
                        target="_blank"
                    >
                        <svg
                        ...
                        <span
                        >Bonus: Register for BaselBoot co-event by
                            letsboot.ch for 90.-- CHF</span
                        >
                    </a>
                </div>
                <div
        ...
        <img
            class="
                ...
                -rotate-12
            "
            src="https://www.baselhack.ch/images/app/logos/baselhack_black.png"
            alt="BaselHack"
        />
    </div>
</div>

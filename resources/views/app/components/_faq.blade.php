    ...
    <div x-data="{ active: 1 }" class="mx-auto max-w-6xl w-full min-h-[16rem]">
        <div x-data="{ id: 1, get expanded() { return this.active === this.id }, set expanded(value) { this.active = value ? this.id : null } }" role="region" class="border-b shadow border-neutral-600">
            <h2 class="py-4 rounded">
                <button x-on:click="expanded = !expanded" :aria-expanded="expanded" class="flex items-center justify-between w-full py-2 text-xl font-bold group">
            ...
            <div x-show="expanded" x-collapse>
                <div class="pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. In magnam quod natus deleniti architecto eaque consequuntur ex, illo neque iste repellendus modi, quasi ipsa commodi saepe? Provident ipsa nulla earum.</div>
            </div>
        </div>
